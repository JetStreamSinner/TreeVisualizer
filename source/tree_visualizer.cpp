...
void TreeVisualizer::render(TreeNode * root, const Color& body_color, const Color& text_color) {
...
void TreeVisualizer::draw_node(TreeNode * node, int x, int y, const Color& body_color, const Color& text_color) {
    ...
    _draw_context->draw_text(text_point, std::to_string(node->val), text_color);
